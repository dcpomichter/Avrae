...
It is also used to apply and direct certain automated aspects through Avrae. Including Class features, Counters, and Lineage. For more information on the system and every aspect check the [Official Wiki](https://wiki.uestrpg.com/wiki/Main_Page)" -f "Supported Subcommands|`race`- Looks up Races and associated features
