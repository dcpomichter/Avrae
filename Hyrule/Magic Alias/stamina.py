...
a=&ARGS&
ch=character()
h,ignore,cc,sb,spt,n,g=a[0] in "help?" if a else True,"-i" in a,"Stamina Meter",ch.spellbook.spells,[0,2,3,5,6,7,9,10,11,12],a[0].lower() if a else '',load_json(get_gvar("51541795-21c7-47b4-bd5d-12a5efcf8b27"))
